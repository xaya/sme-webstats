...
<body>
  <div class="container">
          ...
          <div class="col-12 col-md-12 col-lg-8">
            <nav class="navbar navbar-expand-md">
              ...
              <div class="collapse navbar-collapse" id="navmenu">
                ...
                <a href="player-shares.php" class="active">Player Shares</a>
    ...
    <div class="cont-content">
      ...
      <?php
$string = file_get_contents("players.json");
$data = json_decode($string, true);
$results = $data;
$display = 9999999; // Change this variable to display number of records
...
?>
      ...
      <div class="row">
        <div class="col-12">
          <div class="cont-tbl">
            ...
            <div class="hr-table-heading">Player Shares</div>
            <table class="table tbl-hr tbl-hr-ps display responsive nowrap" width="100%" id="tbl-playershares"
              data-page-length="20" data-length-menu="[20,40,80,160]">
              <thead>
                <tr>
                  <th data-searchable="false">#</th>
                  <th data-priority="1">Player Id</th>
                  ...
                  <th class="text-left" data-searchable="false" data-priority="3">Market Cap</th>
                </tr>
              </thead>
              <tbody>
                <?php $i=1; ?>
  ...
  $(document).ready(function() {
    initNewsTicker();
    initStickyHeader();
    $('#tbl-playershares').DataTable({
      "language": {
        "search": "Search Player ID:"
      }
    });
